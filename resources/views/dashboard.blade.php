...
<div class="py-6">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            ...
            <!-- Tarjeta: Catálogo -->
            <a href="{{ route('pos.index') }}" class="bg-[#028dff] hover:bg-[#0f4db3] transition duration-300 rounded-xl p-5 text-white text-center shadow-lg transform hover:scale-[1.02]">
                ...
                <span class="font-semibold text-md">Catálogo y Pedidos</span>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white rounded-lg p-4 shadow-md border border-gray-100 transform hover:scale-[1.02] transition duration-300">
                <div class="flex items-center justify-between">
                    <span class="text-xl font-bold text-yellow-600" id="kpi-pendientes">24</span>
            ...
            <div class="bg-white rounded-lg p-4 shadow-md border border-gray-100 transform hover:scale-[1.02] transition duration-300">
                <div class="flex items-center justify-between">
                    <span class="text-xl font-bold text-[#028dff]" id="kpi-facturados">18</span>
                ...
                <p class="text-xs font-medium text-gray-600 mt-2">Total Pedidos</p>
                <p class="font-semibold text-gray-800">Facturados</p>
            </div>

            <!-- Pedidos Entregados -->
            <div class="bg-white rounded-lg p-4 shadow-md border border-gray-100 transform hover:scale-[1.02] transition duration-300">
                <div class="flex items-center justify-between">
                    <span class="text-xl font-bold text-green-600" id="kpi-entregados">156</span>
                    <div class="bg-green-100 p-2 rounded-lg">
                        <svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                    </div>
                </div>
                <p class="text-xs font-medium text-gray-600 mt-2">Total Pedidos</p>
                <p class="font-semibold text-gray-800">Entregados</p>
            </div>

            <!-- Gasto Total 30 Días -->
            <div class="bg-white rounded-lg p-4 shadow-md border border-gray-100 transform hover:scale-[1.02] transition duration-300">
                <div class="flex items-center justify-between">
                    <span class="text-xl font-bold text-[#0f4db3]" id="kpi-gasto">$2.4M</span>
                    <div class="bg-blue-100 p-2 rounded-lg">
                ...
                <p class="font-semibold text-gray-800">Últimos 30 Días</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <!-- Performance Chart (2/3 de ancho) -->
            ...
            <div class="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                ...
                <div class="text-center">
                    ...
                    <p class="text-3xl font-bold text-[#0f4db3] mb-2">$850K</p>
                    <p class="text-sm text-gray-600 mb-4">Límite de crédito: $1.2M</p>
                    <div class="w-full bg-gray-200 rounded-full h-2 mb-4">
                        <div class="bg-gradient-to-r from-[#0f4db3] to-[#028dff] h-2 rounded-full" style="width: 71%"></div>
                    </div>
                    <p class="text-xs text-gray-500">71% disponible</p>
                </div>
                <div class="mt-6 pt-4 border-t border-gray-200">
                    <div class="flex justify-between text-sm mb-2">
                        <span class="text-gray-600">Utilizado:</span>
                        <span class="font-medium text-gray-800">$350K</span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600">Próximo vencimiento:</span>
                        <span class="font-medium text-gray-800">15 Feb</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <!-- Filas de Datos (Se llenarán con la variable $latestOrders del controlador) -->
                        <tr class="hover:bg-blue-50 transition duration-150 cursor-pointer">
                            <td class="py-3 px-2 text-sm font-medium text-gray-800">#ORD-2024-001</td>
                            <td class="py-3 px-2 text-sm text-gray-600">15 Ene 2024</td>
                            <td class="py-3 px-2">
                                <span class="inline-flex px-2 py-1 text-xs font-medium bg-green-100 text-green-800 rounded-full">Entregado</span>
                            </td>
                            <td class="py-3 px-2 text-sm font-medium text-gray-800 text-right">$45,200</td>
                        </tr>
                        <tr class="hover:bg-blue-50 transition duration-150 cursor-pointer">
                            <td class="py-3 px-2 text-sm font-medium text-gray-800">#ORD-2024-002</td>
                            <td class="py-3 px-2 text-sm text-gray-600">18 Ene 2024</td>
                            <td class="py-3 px-2">
                                <span class="inline-flex px-2 py-1 text-xs font-medium bg-blue-100 text-[#028dff] rounded-full">Facturado</span>
                            </td>
                            <td class="py-3 px-2 text-sm font-medium text-gray-800 text-right">$32,800</td>
                        </tr>
                        <tr class="hover:bg-blue-50 transition duration-150 cursor-pointer">
                            <td class="py-3 px-2 text-sm font-medium text-gray-800">#ORD-2024-003</td>
                            <td class="py-3 px-2 text-sm text-gray-600">22 Ene 2024</td>
                            <td class="py-3 px-2">
                                <span class="inline-flex px-2 py-1 text-xs font-medium bg-yellow-100 text-yellow-800 rounded-full">Pendiente</span>
                            </td>
                            <td class="py-3 px-2 text-sm font-medium text-gray-800 text-right">$67,500</td>
                        </tr>
                    </tbody>
                </table>
            </div>
